...
// Carousel slide sets generated from scripts/ingest-site-photos.mjs.
// Imported lazily at the bottom of this file so the SiteImage type is in scope.
...
const images = {
  ...
  aboutFounder: {
    src: '/assets/images/team/arvin-halai.webp',
    alt: 'Portrait of Arvin Halai, Founder of Concepto Solutions Ltd.',
    objectPosition: 'center top',
    blurDataURL:
      'data:image/webp;base64,UklGRpgAAABXRUJQVlA4IIwAAABQBQCdASoYABgAPu1mrU+ppSQiMBgIATAdiWgAsR8OhLA7InS20uDbQSsraosVpMPvoAAA/udBRCSkf7Xwvha++2iqDg54wLDW6wxVgJNN7WKqPbK4k+FmLfkhFlXbWbp226p2wl1TiTQWlfyi/m1182cW4SQFOLVLPpEYmKz/8M928+PAsvo64AAAAA==',
  },
  contactHero: {
...
// ---------------------------------------------------------------------------
// Carousel slide sets — generated by scripts/ingest-site-photos.mjs per the
// client DOCX mapping. Each slot is a SiteImage[] suitable for <PhotoCarousel>.
import {
  heroSlides,
  electricalSlides,
  smartHomeSlides,
  ...
  itSupportSlides,
  aboutHeroSlides,
} from './siteImages.generated'

export const carouselImages = {
  homeHero: heroSlides,
  serviceCards: {
    electrical: electricalSlides,
    smartHome: smartHomeSlides,
    security: securitySlides,
    dataFibre: dataFibreSlides,
    itSupport: itSupportSlides,
  },
  aboutHero: aboutHeroSlides,
} as const
