...
const variantStyles: Record<ButtonVariant, string> = {
  ...
  secondary:
    'border border-border bg-white/78 text-text-primary shadow-[0_12px_28px_rgba(33,25,20,0.06)] hover:border-primary/45 hover:bg-white',
  ghost:
    'border border-transparent bg-transparent text-text-secondary hover:border-border/70 hover:bg-white/70 hover:text-text-primary',
}
